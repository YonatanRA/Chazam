...
from chazam.database import Database
...
class SQLDatabase(Database):
	...
	def setup(self):
		"""
		Creates any non-existing tables required for chazam to function.
	...
	def empty(self):
		"""
		Drops tables created by chazam and then creates them again
